...
from fused_driver.msg import Vectornav
...
def imu_code():
    ...
    while True:
        ...
        if(splitline[0]=="$VNYMR"):    
            ...
            Data.imu.header.stamp.secs= rospy.get_rostime().secs
            Data.imu.header.stamp.nsecs= rospy.get_rostime().nsecs

            rpy=convert_to_quaternions(splitline[3],splitline[2],splitline[1])
            ...
            Data.mag_field.header.stamp.secs=rospy.get_rostime().secs
            Data.mag_field.header.stamp.nsecs=rospy.get_rostime().nsecs
            ...
            Data.Header.seq += 1
            Data.Header.stamp.secs=rospy.get_rostime().secs
            Data.Header.stamp.nsecs=rospy.get_rostime().nsecs
