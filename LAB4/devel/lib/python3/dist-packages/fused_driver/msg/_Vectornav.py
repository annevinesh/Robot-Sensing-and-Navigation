...
"""autogenerated by genpy from fused_driver/Vectornav.msg. Do not edit."""
import codecs
import sys
...
class Vectornav(genpy.Message):
  _md5sum = "f5da213f855be49e15ef0f2ad1aaea34"
  _type = "fused_driver/Vectornav"
...
MSG: sensor_msgs/MagneticField
 ...
 float64[9] magnetic_field_covariance # Row major about x, y, z axes
  ...
  __slots__ = ['Header','imu','mag_field','Vectornav']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Header,imu,mag_field,Vectornav
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.Vectornav = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.Vectornav = str[start:end]
      return self
